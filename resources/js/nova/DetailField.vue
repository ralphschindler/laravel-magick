<template>
  <panel-item :field="field">
    <template slot="value">
      ...
      <div v-if="images.length > 0" :class="`flex flex-wrap mb-2 laravel-magick-${this.resourceName}`">

        <div v-if="!field.isCollection" class="flex flex-wrap mb-2 laravel-magick-articles">
    ...
    computed: {
      images () {
        ...
        return images.map((image, i) => {
          return {
            inputId: 'magick-' + this.field.attribute + '-' + i,
